    ...
    return (
      <div>
        <div style={panelFormItemStyle}>
          <label htmlFor="state" style={labelStyle}>Default state</label>
          <input
            style={inputStyle}
            type="checkbox"
            id="state"
        ...
        <div style={panelFormItemStyle}>
          <label style={labelStyle} htmlFor="toggle">Toggle key</label>
          <select
            style={selectStyle}
            key={'toggle'}
            id="toggle"
          ...
          >
            <option key={'Escape'} value="Escape">Escape</option>
