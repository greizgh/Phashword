...
function onToggleKeyChange(pref) {
  workers.forEach(function(worker){
    worker.port.emit("update_prefs", {"key": require("sdk/simple-prefs").prefs.toggle_key});
  });
}
require("sdk/simple-prefs").on("toggle_key", onToggleKeyChange);
...
var selector = pageMod.PageMod({
  ...
  contentScriptOptions: {"key": require("sdk/simple-prefs").prefs.toggle_key},
